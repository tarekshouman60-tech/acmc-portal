...
<div class="body">
  ...
  ${d.notes.trim()?`<div class="sec"><div class="sec-title">Notes to RTT</div><div class="nbox">${d.notes}</div></div>`:''}
  <div class="div"></div>
  <div class="sig">
    <div class="sb"><div class="sl">Referring physician</div><div class="sn">${d.doctor}</div></div>
    <div class="sb"><div class="sl">Received by (ACMC RTT team)</div><div class="sn" style="color:#ccc">______________________________</div></div>
  </div>
</div>
